...
const FinalCTASection = () => {
  ...
  return <section className="py-20 md:py-28 px-6 md:px-12 gradient-hero">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <Button onClick={scrollToContact} size="lg" className="bg-highlight hover:bg-highlight/90 text-primary font-bold rounded-full px-6 md:px-10 py-6 md:py-7 text-base md:text-lg group shadow-xl hover:shadow-2xl transition-all max-w-full">
        ...
        <div className="mt-12 flex flex-col sm:flex-row justify-center gap-6">
          ...
          return <div key={index} className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full">
